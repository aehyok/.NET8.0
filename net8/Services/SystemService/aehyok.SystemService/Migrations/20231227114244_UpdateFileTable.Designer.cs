...
namespace aehyok.SystemService.Migrations
{
    ...
    [Migration("20231227114244_UpdateFileTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aehyok.Basic.Domains.ApiResource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("aehyok.SystemService.Domains.MessageQueueEventHandler", b =>
                {
                    ...
                    b.ToTable("MessageQueueEventHandler");
                });

            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("aehyok.Basic.Domains.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("aehyok.Basic.Domains.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("aehyok.Basic.Domains.MenuResource", b =>
                {
                    b.HasOne("aehyok.Basic.Domains.ApiResource", "ApiResource")
                        .WithMany()
