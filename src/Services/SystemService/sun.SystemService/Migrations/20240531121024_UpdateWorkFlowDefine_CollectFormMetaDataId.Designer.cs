...
namespace sun.SystemService.Migrations
{
    ...
    [Migration("20240531121024_UpdateWorkFlowDefine_CollectFormMetaDataId")]
    partial class UpdateWorkFlowDefine_CollectFormMetaDataId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sun.Core.Domains.CollectFormMetaData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CollectFormMetaData", t =>
                        {
                            t.HasComment("form表单元数据实体");
                        });
                });

            modelBuilder.Entity("sun.Core.Domains.CollectFormMetaDataLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("xsxh")
                        .HasColumnType("longtext")
                        .HasComment("显示顺序");

                    b.Property<string>("zbcxsf")
                        .HasColumnType("longtext")
                        .HasComment("指标查询算法 指标查询的SELECT语句");

                    b.Property<string>("zbmc")
                        .HasColumnType("longtext")
                        .HasComment("指标名称");

                    b.Property<string>("zbmeta")
                        .HasColumnType("longtext")
                        .HasComment("指标元数据");

                    b.Property<string>("zbsf")
                        .HasColumnType("longtext")
                        .HasComment("指标算法");

                    b.Property<string>("zbsm")
                        .HasColumnType("longtext")
                        .HasComment("指标说明");
                    ...
                    b.ToTable("CollectFormMetaDataLine", t =>
                        {
            ...
            modelBuilder.Entity("sun.Core.Domains.WorkFlowActioncirculateConfig", b =>
                {
                    ...
                    b.Property<long>("TargetRegionId")
                        .HasColumnType("bigint")
                        .HasComment("目标所属区域Id");
                    ...
                    b.Property<long>("WorkFlowActionId")
                        .HasColumnType("bigint")
                        .HasComment("所在流程的动作Id");

                    b.Property<long>("WorkFlowStateConfigId")
                        .HasColumnType("bigint")
                        .HasComment("工作流 状态配置Id");
            ...
            modelBuilder.Entity("sun.NCDP.Domains.AutoForm", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("sun.NCDP.Domains.AutoGuideLine", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
